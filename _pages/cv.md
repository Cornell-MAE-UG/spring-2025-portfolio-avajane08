---
layout: default
title: Ava Farkash - Curriculum Vitae
permalink: /cv/
---
## Curriculum Vitae
...
#### Objective
Engineering student with a strong foundation in understanding our physical world with mathmatical and scientific concepts from the classroom. Passionate about engines, planes, tech theater and eager to apply my knowledge in real-world applications.
...
- **Testing Rig for Landing Gear - DBF**:  
  *Designed and built a wooden test rig for the front landing gear of the plane so we could determine the applied load the gear could tolerate. Used a digital hanging scale to pull down on gear and acquired data from the reading as well as the displacement of the top of the landing gear to where it was pulled to. Completed over the course of the first semester of the 24-25 season. *  
...
- **Torque Wrench Analysis - MAE 3270**:  
  *Used a MatLab script and Ansys to confirm the data for a given torque wrench design. Created another MatLab script to generate possible custom designs based off of requirements for various safety factors and torque wrench sensitivity output.*  
  - Strengthened my ability to use and understand Ansys  
  - Improved my time management skills; this was a pretty long project and I completed it over about a week
...
- **Special Events Crew - Performing Media Arts Department - Crew Member**  
  ...
  - Job completed upon request by PMA Production Manager   
...
- Member of CU Design Build Fly
- Member of Cog Dog Theater Troupe
